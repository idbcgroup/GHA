...
/*
  ...
  Version v9.1p_2014-08-17/EVAL Development Only (2014-08-17)
...
if (window.isc && isc.version != "v9.1p_2014-08-17/EVAL Development Only") {
    isc.logWarn("SmartClient module version mismatch detected: This application is loading the core module from "
        + "SmartClient version '" + isc.version + "' and additional modules from 'v9.1p_2014-08-17/EVAL Development Only'. Mixing resources from different "
...
//    layoutMargin:null,
    ...
    //> @attr layout.resizeBar (MultiAutoChild Splitbar : : A)
...
// directly on the +link{iconButton.icon, icon} or the +link{iconButton.menuIcon, menuIcon},
