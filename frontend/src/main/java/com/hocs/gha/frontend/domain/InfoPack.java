...
/**
 * <p>Java class for InfoPack complex type.
 * 
 ...
 *         &lt;element name="data" type="{http://www.example.org/schema3}infoPackData" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "InfoPack", namespace = "http://www.example.org/schema3", propOrder = {
    "isUnique",
    "data"
})
public class InfoPack {
    ...
    protected List<InfoPackData> data;
     ...
     * 
     */
    public List<InfoPackData> getData() {
        if (data == null) {
            data = new ArrayList<InfoPackData>();
        }
        return this.data;
    }
